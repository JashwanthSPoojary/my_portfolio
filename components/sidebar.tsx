          ...
          <nav className="space-y-6 flex-1">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="https://drive.google.com/file/d/1RVsMod7l9xN_sGC-k9bEr9Ro_rmRmQkH/view?usp=sharing" target="_blank" className="flex items-center gap-3 text-gray-300 hover:text-white transition">
